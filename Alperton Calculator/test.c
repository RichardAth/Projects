	...
	while (debug_code != 0) {
		...
		*/
		...
		case 16: {		// #elif DEBUG_CODE == 16
			quadmodText("1", "0", "-41", "5^10", 6); /* 1 x = 891321,  2 x = 8874304 */
			//quadmodText("7", "3", "5", "77", 6);   /* x =3, x = 17 */
			//quadmodText("8", "3", "7", "16", 6);   /* x = 11 */
			//quadmodText("1", "1", "-42", "10000", 6);  /* x = 6, 1881, 8118, 9993 */
			//quadmodText("1", "0", "-41", "625", 6);  /* x = 71, 554 */
			//quadmodText("1", "1", "0", "112856782", 6); /* x = 0, 56428390,56428391,112856781 */
			//  quadmodText("1", "1", "0", "56428391", 6);  /* x = 0, 56428390 */
			//  quadmodText("1", "1", "0", "2", 6);    /* x = 0, 1 */
			printf("%s\n", output);
			break;
		}
		case 17: {
