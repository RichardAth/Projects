...
; dword ptr(4 byte) is replaced by qword ptr(8 byte), and registernames
...
; before compiling this, go to Solution Explorer window, right-click
; on project, select Build Dependencies > Build Customisations and check
; that the masm box is ticked.
; Then right-click on the element Int128x64.asm, click properties and 
; check that the type is Microsoft Macro Assembler.
