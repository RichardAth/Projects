...
int BigIntToBigNbr(const BigInteger *pBigNbr, int BigInt[]);
void BigNbrToBigInt(BigInteger *pBigNbr, const int BigInt[], int nbrLenBigInt);
//int BigNbrIsZero(const limb *pNbr);
void GcdBigNbr(const int *pNbr1, const int *pNbr2, int *pGcd, int nbrLen);
void AdjustBigIntModN(int *Nbr, const int *Mod, int nbrLen);
