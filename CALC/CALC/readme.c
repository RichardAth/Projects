...
void readme()
{
	...
	const char absmod_str[] = "absmod";
	const char euclid_str[] = "euclid";
	const char gcd_str[] = "gcd";
	const char gcdv_str[] = "gcdv";
	const char gcda_str[] = "gcda";
	const char gcdav_str[] = "gcdav";
	const char egcd_str[] = "egcd";
	const char sgcd_str[] = "sgcd";
	const char lllgcd_str[] = "lllgcd";
	const char lllgcd0_str[] = "lllgcd0";
	const char lllhermite_str[] = "lllhermite";
	const char axb_str[] = "axb";
	const char fp_str[] = "fp";
	const char inhomfp_str[] = "inhomfp";
	const char slv_str[] = "slv";
	const char lcm_str[] = "lcm";
	const char lcma_str[] = "lcma";
	const char length_str[] = "length";
	const char pollard_str[] = "pollard";
	const char nprime_str[] = "nprime";
	const char nprimeap_str[] = "nprimeap";
	const char jacobi_str[] = "jacobi";
	const char peralta_str[] = "peralta";
	const char cong_str[] = "congr";
	const char chinese_str[] = "chinese";
	const char chinesea_str[] = "chinesea";
	const char mthroot_str[] = "mthroot";
	const char mthrootr_str[] = "mthrootr";
	const char fund_str[] = "fund";
	const char pell_str[] = "pell";
	const char surd_str[] = "surd";
	const char mpower_str[] = "mpower";
	const char inv_str[] = "inv";
	const char elliptic_str[] = "elliptic";
	const char factor_str[] = "factor";
	const char tau_str[] = "tau";
	const char sigma_str[] = "sigma";
	const char mobius_str[] = "mobius";
	const char euler_str[] = "euler";
	const char lprimroot_str[] = "lprimroot";
	const char orderm_str[] = "orderm";
	const char lucas_str[] = "lucas";
	const char serret_str[] = "serret";
	const char collatz_str[] = "collatz";
	const char cycle_str[] = "cycle";
	const char miller_str[] = "miller";
	const char hermite_str[] = "hermite";
	const char improvep_str[] = "improvep";
	const char mlll_str[] = "mlll";
	const char smith_str[] = "smith";
	const char rsae_str[] = "rsae";
	const char encode_str[] = "encode";
	const char decode_str[] = "decode";
	const char addcubicr_str[] = "addcubicr";
	const char powercubicr_str[] = "powercubicr";
	const char ordercubicr_str[] = "ordercubicr";
	const char addcubicm_str[] = "addcubicm";
	const char powercubicm_str[] = "powercubicm";
	const char ordercubicm_str[] = "ordercubicm";
	const char convergents_str[] = "convergents";
	const char lagrange_str[] = "lagrange";
	const char perfectpower_str[] = "perfectpower";
	const char leastqnr_str[] = "leastqnr";
	const char examples_str[] = "examples";
	const char content_str[] = "content";
	const char primitive_str[] = "primitive";
	const char sturm_str[] = "sturm";
	const char rootexp_str[] = "rootexp";
	const char log_str[] = "log";
	const char log1_str[] = "log1";
	const char log2_str[] = "log2";
	const char sqroot_str[] = "sqroot";
	const char cornacchia_str[] = "cornacchia";
	const char patz_str[] = "patz";
	const char congq_str[] = "congq";
	const char binform_str[] = "binform";
	const char ceil_str[] = "ceil";
	const char testlog_str[] = "testlog";
	const char resultant_str[] = "resultant";
	const char discriminant_str[] = "discriminant";
	const char deriv_str[] = "deriv";
	const char primes_str[] = "primes";
	const char sturmsequence_str[] = "sturmsequence";
	const char cyclotomic_str[] = "cyclotomic";
	const char classnop_str[] = "classnop";
	const char classnon_str[] = "classnon";
	const char nearint_str[] = "nearint";
	const char reduceneg_str[] = "reduceneg";
	const char reducepos_str[] = "reducepos";
	const char classnop0_str[] = "classnop0";
	const char tableneg_str[] = "tableneg";
	const char tablepos_str[] = "tablepos";
	const char davison_str[] = "davison";
	const char raney_str[] = "raney";
	const char unimodular_str[] = "unimodular";
	const char twoadicsqrt_str[] = "twoadicsqrt";
	const char padicsqrt_str[] = "padicsqrt";
	const char sigmak_str[] = "sigmak";
	const char ramanujan_str[] = "ramanujan";
	const char repdefinite_str[] = "repdefinite";
	const char powerd_str[] = "powerd";
	const char euclid1_str[] = "euclid1";
	const char rcf_period_str[] = "rcfperiod";
	const char nscf_period_str[] = "nscfperiod";
	const char alg_cycle_str[] = "algcycle";
	const char spiral_str[] = "spiral";
	const char spiralinverse_str[] = "spiralinverse";
	const char nicf_period_str[] = "nicfperiod";
	const char rcf_period0_str[] = "rcfperiod0";
	const char nscf_period0_str[] = "nscfperiod0";
	const char nicf_period0_str[] = "nicfperiod0";
	const char carmichael_str[] = "carmichael";
	const char carnielli_str[] = "carnielli";
	const char lupei_str[] = "lupei";
	const char tangent_str[] = "tangent";
	const char bernoulli_str[] = "bernoulli";
	const char partition_str[] = "partition";
	const char twocycle_str[] = "twocycle";
	const char mcycle_str[] = "mcycle";
	const char pqcycle_str[] = "pqcycle";
	const char mmcycle_str[] = "mmcycle";
	const char exceptionals[] = "exceptionals";
	const char exceptionals0[] = "exceptionals0";
	const char fg[] = "fg";
	const char exceptionals10[] = "exceptionals10";
	const char gplus[] = "gplus";
	const char gzero[] = "gzero";
	const char gminus[] = "gminus";
	const char nagell[] = "nagell";
	const char frattini[] = "frattini";
	const char kashihara[] = "kashihara";
	const char branch[] = "branch";
	const char ternary[] = "ternary";
	const char pell4[] = "pell4";
	const char lprimefactor[] = "lprimefactor";
	const char minarray[] = "minarray";
	const char conwaycycles[] = "conwaycycles";
	const char conwayrangetest1[] = "conwayrangetest1";
	while (1)
	{
		printf("          **************************\n");
