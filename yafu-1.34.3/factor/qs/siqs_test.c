...
void siqsbench(fact_obj_t *fobj)
{
	...
	strcpy_s(oldflogname, sizeof(oldflogname),fobj->flogname);

	strcpy_s(list[0], 200, "405461849292216354219321922871108605045931309");
	strcpy_s(list[1], 200, "29660734457033883936073030405220515257819037444591");
	strcpy_s(list[2], 200, "1592739380299790264815370870751381488173344970710983383");
	strcpy_s(list[3], 200, "349594255864176572614071853194924838158088864370890996447417");
	strcpy_s(list[4], 200, "34053408309992030649212497354061832056920539397279047809781589871");
	strcpy_s(list[5], 200, "6470287906463336878241474855987746904297564226439499503918586590778209");
	strcpy_s(list[6], 200, "281396163585532137380297959872159569353696836686080935550459706878100362721");
	strcpy_s(list[7], 200, "33727095233132290409342213138708322681737322487170896778164145844669592994743377");
	strcpy_s(list[8], 200, "7456482836301983072751757080079609980368702375378513429852397523678294751191007081");
	strcpy_s(list[9], 200, "1877138824359859508015524119652506869600959721781289179190693027302028679377371001561");

	strcpy_s (fobj->flogname, sizeof(fobj->flogname), "bench.log");
	...
	strcpy_s(fobj->flogname, sizeof(fobj->flogname), oldflogname);
