...
/* find the most significant 1-bit. bits are numbered from 1 to 64.
if n is zero return 0 
_BitScanReverse would be faster */
int bits64(uint64 n)
{
...
{	
	fp_digit v1=0, v2=0, k, qhat, rhat,
	uj2, tt[2], pp[2];
	int i,j,m,su,sv;
	int s =0,cmp,sdd,sd;
	unsigned int shift;
...
static const uint64 LEFTSHIFTMASKS64[64] = {
...
static const uint32 LEFTSHIFTMASKS32[32] = {
...
static const uint64 RIGHTSHIFTMASKS64[64] = {
...
static const uint32 RIGHTSHIFTMASKS32[32] = {
