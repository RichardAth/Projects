...
long long
list_mul_mem (unsigned long long len)
{
  return 2 * len;
}
...
listz_t
init_list (unsigned long long n)
{
  listz_t p;
...
listz_t
init_list2 (unsigned long long n, unsigned int N)
{
  listz_t p;
  unsigned int i;
...
void
clear_list (listz_t p, unsigned long long n)
{
  unsigned int i;
...
int
list_inp_raw (listz_t a, FILE *f, unsigned long long n)
{
  unsigned long long i;
...
/* Write all entries in list to stream. 
   Return 0 on success, ECM_ERROR on error */
int
list_out_raw (FILE *f, listz_t a, unsigned long long n)
{
  unsigned int i;
...
/* p <- q */
void
list_set (listz_t p, listz_t q, unsigned long long n)
{
  unsigned long long i;
...
/* p[0] <-> p[n-1], p[1] <-> p[n-2], ... */
void
list_revert (listz_t p, unsigned long long n)
{
  unsigned long long i;
...
void
list_swap (listz_t p, listz_t q, unsigned long long n)
{
  unsigned long long i;
...
void
list_neg (listz_t p, listz_t q, unsigned long long l, mpz_t n)
{
  unsigned long long i;
...
/* p <- q modulo mod */
void
list_mod (listz_t p, listz_t q, unsigned long long n, mpz_t mod)
{
  unsigned long long i;
...
/* p <- q + r */
void
list_add (listz_t p, listz_t q, listz_t r, unsigned long long l)
{
  unsigned long long i;
...
/* p <- q - r */
void
list_sub (listz_t p, listz_t q, listz_t r, unsigned long long l)
{
  unsigned long long i;
...
void 
list_mulup (listz_t l, unsigned long long k, mpz_t n, mpz_t t)
{
  unsigned long long i;
...
/* p <- 0 */
void
list_zero (listz_t p, unsigned long long n)
{
  unsigned long long i;
...
*/
void
list_mul_high (listz_t a, listz_t b, listz_t c, unsigned long long K)
{
  list_mult_n (a, b, c, K);
}
...
*/
void
list_mul (listz_t a, listz_t b, unsigned long long k,
          listz_t c, unsigned long long l, int monic, listz_t t)
{
	unsigned long long i;
	unsigned long long po2;
 ...
 */
void
list_mulmod (listz_t a2, listz_t a, listz_t b, listz_t c, unsigned long long k,
              listz_t t, mpz_t n)
{
  long long i;
...
*/
void
PolyFromRoots (listz_t G, listz_t a, unsigned long long k, listz_t T, mpz_t n)
{
...
*/
int
PolyFromRoots_Tree (listz_t G, listz_t a, unsigned long long k, listz_t T, 
               long long dolvl, mpz_t n, listz_t *Tree, FILE *TreeFile, 
               unsigned long long sh)
{
  ...
  if (dolvl != 0) /* either dolvl < 0 and we need to compute all levels,
                     or dolvl > 0 and we need first to compute lower levels */
    {
      ...
      PolyFromRoots_Tree (H1 + l, a + l, m, T, dolvl - 1, n, NextTree, TreeFile, sh + l);
    }
  if (dolvl <= 0)
    {
...
*/
void
PolyInvert (listz_t q, listz_t b, unsigned long long K, listz_t t, mpz_t n)
{
  if (K == 1)
    {
      mpz_set_ui (q[0], 1);
...
PrerevertDivision (listz_t a, listz_t b, listz_t invb,
                   unsigned long long K, listz_t t, mpz_t n)
{
  int wrap;
  long long po2;
  listz_t t2 = NULL;
  ...
  if (Fermat && po2)
  ...
  else /* non-Fermat case */
    {
      ...
      if (wrap)
	{
	  t2 = init_list2 (K - 1, (unsigned int)mpz_sizeinbase (n, 2));
