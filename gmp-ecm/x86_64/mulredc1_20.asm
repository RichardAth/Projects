# mp_limb_t mulredc1_20(mp_limb_t * z, const mp_limb_t x, const mp_limb_t * y,
...
# We have CY:T1 <= 2 * 2^64 - 2
	...
	# rdx:rax <= 2^128 - 2*2^64 + 1, T1:T0 <= 2^128 - 1
	addq	T0, %rax	# Add T0 and low word
	movq	%rax, 88(ZP)	# Store T0 in z[12-1]
...
# We have CY:T1 <= 2 * 2^64 - 2
	...
	# rdx:rax <= 2^128 - 2*2^64 + 1, T1:T0 <= 2^128 - 1
	addq	T0, %rax	# Add T0 and low word
	movq	%rax, 96(ZP)	# Store T0 in z[13-1]
...
# We have CY:T1 <= 2 * 2^64 - 2
	...
	# rdx:rax <= 2^128 - 2*2^64 + 1, T1:T0 <= 2^128 - 1
	addq	T0, %rax	# Add T0 and low word
	movq	%rax, 104(ZP)	# Store T0 in z[14-1]
...
# We have CY:T1 <= 2 * 2^64 - 2
	...
	# rdx:rax <= 2^128 - 2*2^64 + 1, T1:T0 <= 2^128 - 1
	addq	T0, %rax	# Add T0 and low word
	movq	%rax, 112(ZP)	# Store T0 in z[15-1]
...
# We have CY:T1 <= 2 * 2^64 - 2
	...
	# rdx:rax <= 2^128 - 2*2^64 + 1, T1:T0 <= 2^128 - 1
	addq	T0, %rax	# Add T0 and low word
	movq	%rax, 120(ZP)	# Store T0 in z[16-1]
...
# We have CY:T1 <= 2 * 2^64 - 2
	...
	# rdx:rax <= 2^128 - 2*2^64 + 1, T1:T0 <= 2^128 - 1
	addq	T0, %rax	# Add T0 and low word
	movq	%rax, 128(ZP)	# Store T0 in z[17-1]
...
# We have CY:T1 <= 2 * 2^64 - 2
	...
	# rdx:rax <= 2^128 - 2*2^64 + 1, T1:T0 <= 2^128 - 1
	addq	T0, %rax	# Add T0 and low word
	movq	%rax, 136(ZP)	# Store T0 in z[18-1]
...
# Pass for j = 19. Don't fetch new data from y[j+1].
	...
	mulq    U		# m[j]*u
	addq	%rax, T0	# Add low word to T0
	movq	T0, 144(ZP)	# Store T0 in z[j-1]
	adcq	%rdx, T1	# Add high word with carry to T1
	movq	T1, 152(ZP)	# Store T1 in tmp[j]
	setc	CYb		# %CY <= 1
