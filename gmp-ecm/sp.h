...
/* length of a spv */
typedef unsigned long long spv_size_t;
...
{
  if (sizeof (sp_t) == sizeof (unsigned __int64))
    {
...
void mpzspv_mul_ntt (mpzspv_t, const spv_size_t, mpzspv_t, const spv_size_t, 
	const spv_size_t, mpzspv_t, const spv_size_t, const spv_size_t, 
	const spv_size_t, const int, const spv_size_t, mpzspm_t, const int);
void mpzspv_random (mpzspv_t, spv_size_t, spv_size_t, mpzspm_t);
void mpzspv_to_dct1 (mpzspv_t, const mpzspv_t, const spv_size_t, const spv_size_t, 
	mpzspv_t, const mpzspm_t);
void mpzspv_mul_by_dct (mpzspv_t, const mpzspv_t, const spv_size_t, const mpzspm_t, 
    const int);
void mpzspv_sqr_reciprocal (mpzspv_t, const spv_size_t, const mpzspm_t);
