...
static void list_add_wrapper (listz_t, listz_t, listz_t, unsigned long long,
                              unsigned long long);
static void list_sub_wrapper (listz_t, listz_t, listz_t, unsigned long long,
                              unsigned long long);
static unsigned long long TKarMul  (listz_t, unsigned long long, listz_t, unsigned long long,
                              listz_t, unsigned long long, listz_t);
static void list_sub_safe    (listz_t, listz_t, listz_t, unsigned long long,
                              unsigned long long, unsigned long long);
static void list_add_safe    (listz_t, listz_t, listz_t, unsigned long long,
                              unsigned long long, unsigned long long);
static unsigned long long TToomCookMul (listz_t, unsigned long long, listz_t, unsigned long long,
                                  listz_t, unsigned long long, listz_t);
static unsigned long long TToomCookMul_space (unsigned long long, unsigned long long,
                                        unsigned long long);

static void
list_add_wrapper (listz_t p, listz_t q, listz_t r, unsigned long long n,
...
static void
list_sub_wrapper (listz_t p, listz_t q, listz_t r, unsigned long long n,
                  unsigned long long max_r)
{
...
TKarMul (listz_t b, unsigned long long n,
	 listz_t a, unsigned long long m, listz_t c, unsigned long long l, listz_t t)
{
  unsigned long long k, mu, nu, h;
  unsigned long long s1;
  unsigned long long tot_muls = 0;
#ifdef DEBUG
...
static unsigned long long
TKarMul_space (unsigned long long n, unsigned long long m, unsigned long long l)
{
  unsigned long long mu, nu, h;
  unsigned long long s1;
...
list_sub_safe (listz_t ret, listz_t a, listz_t b,
               unsigned long long sizea, unsigned long long sizeb,
...
static unsigned long long
TToomCookMul (listz_t b, unsigned long long n,
              listz_t a, unsigned long long m, listz_t c, unsigned long long l, 
              listz_t tmp)
{
    unsigned long long nu, mu, h;
    unsigned int i;
    unsigned long long btmp;
    unsigned long long tot_muls = 0;
...
unsigned long long
TToomCookMul_space (unsigned long long n, unsigned long long m, unsigned long long l)
              
{
    unsigned long long nu, mu, h;
    unsigned long long stmp1, stmp2;
...
*/
long long
TMulGen (listz_t b, unsigned long long n, listz_t a, unsigned long long m,
         listz_t c, unsigned long long l, listz_t tmp, mpz_t modulus)
{
  ASSERT (n <= l);
...
unsigned long long
TMulGen_space (unsigned long long n, unsigned long long m, unsigned long long l)
{
    if (Fermat)
      return 2 * (l + 1);
    else
